            ...
            <div class="content">
                <div class="row">
                    ...
                    <div class="col-sm-8 col-9 text-right m-b-20">
                        <a href="add_packages" class="btn btn btn-primary btn-rounded float-right"><i class="fa fa-plus"></i> Add Packages</a>
                    </div>
                </div>
				<div class="row">
					<div class="col-md-12">
						<div class="table-responsive">
                          ...
                          @foreach($packages as $packages)
                                   ...
                                   <th>{{$packages['package_image']}}</th>
                                    <th>{{$packages['package_name']}}</th>
                                   <th>{{$packages['package_desc']}}</th>
                                    <th>{{$packages['hotel']}}</th>
                                    <th>{{$packages['price']}}</th>
                                    <th>{{$packages['uploaded_at']}}</th>
                                    </tr>
